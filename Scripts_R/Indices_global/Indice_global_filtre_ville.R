                                ...
                                Partner = "All") 
{
  ...
  if (Exports_imports == "Imports") {
    write.csv2(rt_index, 
               file = "./Bases_de_donnees_finales/Indices_globaux/Indice_global_filtre_ville_imports.csv",
               row.names = F)
  } else {
    write.csv2(rt_index, 
               file = "./Bases_de_donnees_finales/Indices_globaux/Indice_global_filtre_ville_exports.csv",
               row.names = F)
  }
